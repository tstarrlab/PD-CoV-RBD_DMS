Compute per-barcode pAPN binding
================
Tyler Starr
12/30/2022
...
```
    ...
    ## [1] "read:cell ratio for lib55 pAPN_01_bin1 is 1.14473151521041"
    ## [1] "read:cell ratio for lib55 pAPN_01_bin2 is 1.88063335207199"
    ## [1] "read:cell ratio for lib55 pAPN_01_bin3 is 3.41280831186973"
    ## [1] "read:cell ratio for lib55 pAPN_01_bin4 is 1.1950884685784"
    ## [1] "reads < cells for lib56 pAPN_01_bin1 , un-normalized (ratio 0.953227253824772 )"
    ## [1] "reads < cells for lib56 pAPN_01_bin2 , un-normalized (ratio 0.816877011578897 )"
    ## [1] "read:cell ratio for lib56 pAPN_01_bin3 is 1.2613946240748"
    ## [1] "read:cell ratio for lib56 pAPN_01_bin4 is 1.59330220576397"
...
Filter out pAPN_meanF measurements determined from \<10 estimated cells
...
<img src="compute_pAPN_meanF_files/figure-gfm/pAPN_meanF_distribution_vioplot-1.png" style="display: block; margin: auto;" />
...
We have generated pAPN_meanF measurements for 71.68% of the barcodes in
our libraries.
