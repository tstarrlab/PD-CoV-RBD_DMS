...
```
    ...
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin1 is 2.55682159284727"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin2 is 2.08485075620472"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin3 is 2.46192589528245"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin4 is 2.69635958499615"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin1 , un-normalized (ratio 0.0317160638974468 )"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin2 , un-normalized (ratio 0.00553751396838554 )"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin3 , un-normalized (ratio 0.160456521628417 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_02_bin4 is 2.23544563574822"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin1 is 2.71523842331283"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin2 is 2.46550669913432"
    ## [1] "reads < cells for lib55A TiteSeq_03_bin3 , un-normalized (ratio 0.221604445575455 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin4 is 3.34124865079816"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin1 is 2.36649688091872"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin2 is 2.51063351012608"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin3 is 3.1048773006135"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin4 is 11.3916406471757"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin1 is 2.50161926546679"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin2 is 2.14474662849605"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin3 is 13.8665734021159"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin4 is 2.76719229084538"
    ## [1] "reads < cells for lib55A TiteSeq_06_bin1 , un-normalized (ratio 0.990460197524445 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_06_bin2 is 2.42899155861784"
    ## [1] "reads < cells for lib55A TiteSeq_06_bin3 , un-normalized (ratio 0.376166941241076 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_06_bin4 is 5.47926267281106"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin1 is 1.63110369005302"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin2 is 3.12752442760283"
    ## [1] "reads < cells for lib55A TiteSeq_07_bin3 , un-normalized (ratio 0.435714285714286 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin4 is 2.48571428571429"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin1 is 1.26849707586824"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin2 is 2.50954131519136"
    ## [1] "reads < cells for lib55A TiteSeq_08_bin3 , un-normalized (ratio 0.794759825327511 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin4 is 45.2083333333333"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin1 is 1.65365368882592"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin2 is 2.00832891225523"
    ## [1] "reads < cells for lib55A TiteSeq_09_bin3 , un-normalized (ratio 0.978494623655914 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin4 is 1.16"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin1 , un-normalized (ratio 0.827877650279741 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_01_bin2 is 1.05651724180905"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin3 , un-normalized (ratio 0.916579043013658 )"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin4 , un-normalized (ratio 0.956091705445082 )"
    ## [1] "reads < cells for lib56A TiteSeq_02_bin1 , un-normalized (ratio 0.870216132072158 )"
    ## [1] "reads < cells for lib56A TiteSeq_02_bin2 , un-normalized (ratio 0.933276908094551 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_02_bin3 is 1.06933550222424"
    ## [1] "read:cell ratio for lib56A TiteSeq_02_bin4 is 1.06919651261899"
    ## [1] "reads < cells for lib56A TiteSeq_03_bin1 , un-normalized (ratio 0.934562892104484 )"
    ## [1] "reads < cells for lib56A TiteSeq_03_bin2 , un-normalized (ratio 0.990531640307333 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_03_bin3 is 1.1249373418628"
    ## [1] "read:cell ratio for lib56A TiteSeq_03_bin4 is 2.07904568394835"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin1 is 1.02173094249011"
    ## [1] "reads < cells for lib56A TiteSeq_04_bin2 , un-normalized (ratio 0.942720707548011 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin3 is 1.4288053445114"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin4 is 6.75487346707308"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin1 , un-normalized (ratio 0.986890891858723 )"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin2 , un-normalized (ratio 0.822459696144514 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_05_bin3 is 3.83339545285129"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin4 , un-normalized (ratio 0.44311377245509 )"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin1 , un-normalized (ratio 0.872009009350998 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_06_bin2 is 1.39741018619377"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin3 , un-normalized (ratio 0.772389905987135 )"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin4 , un-normalized (ratio 0.433862433862434 )"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin1 , un-normalized (ratio 0.762294848595406 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_07_bin2 is 1.27849073877291"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin3 , un-normalized (ratio 0.368821292775665 )"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin4 , un-normalized (ratio 0.571428571428571 )"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin1 , un-normalized (ratio 0.911117715495949 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_08_bin2 is 1.35229088476831"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin3 , un-normalized (ratio 0.345545378850958 )"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin4 , un-normalized (ratio 0.403846153846154 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin1 , un-normalized (ratio 0.865508796184344 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin2 , un-normalized (ratio 0.645252104881226 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin3 , un-normalized (ratio 0.47037037037037 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin4 , un-normalized (ratio 0.340909090909091 )"
...
We successfully generated *K*<sub>D</sub> estimates for 33768 of our
lib55A barcodes (75.41%), and 22150 of our lib56A barcodes (72.05%).
...
We have generated binding measurements for 72.86% of the barcodes in our
libraries.
