...
```
    ...
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin1 is 2.56731541679463"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin2 is 2.09111145081834"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin3 is 2.46792070594462"
    ## [1] "read:cell ratio for lib55A TiteSeq_01_bin4 is 2.71084592533518"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin1 , un-normalized (ratio 0.0317932992162999 )"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin2 , un-normalized (ratio 0.00557074080097652 )"
    ## [1] "reads < cells for lib55A TiteSeq_02_bin3 , un-normalized (ratio 0.161046724487307 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_02_bin4 is 2.24774419830392"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin1 is 2.7243590052232"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin2 is 2.47494663219661"
    ## [1] "reads < cells for lib55A TiteSeq_03_bin3 , un-normalized (ratio 0.222803585034317 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_03_bin4 is 3.35493949894904"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin1 is 2.37471158377902"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin2 is 2.52313057882578"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin3 is 3.12079754601227"
    ## [1] "read:cell ratio for lib55A TiteSeq_04_bin4 is 11.4322665342038"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin1 is 2.51160528162163"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin2 is 2.15350341711222"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin3 is 13.9829500743202"
    ## [1] "read:cell ratio for lib55A TiteSeq_05_bin4 is 2.76259307928165"
    ## [1] "reads < cells for lib55A TiteSeq_06_bin1 , un-normalized (ratio 0.994342713003507 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_06_bin2 is 2.43495094173766"
    ## [1] "reads < cells for lib55A TiteSeq_06_bin3 , un-normalized (ratio 0.377814387699066 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_06_bin4 is 5.50460829493088"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin1 is 1.63743503067998"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin2 is 3.14292869898515"
    ## [1] "reads < cells for lib55A TiteSeq_07_bin3 , un-normalized (ratio 0.431746031746032 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_07_bin4 is 2.51428571428571"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin1 is 1.27382827765178"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin2 is 2.51909025733331"
    ## [1] "reads < cells for lib55A TiteSeq_08_bin3 , un-normalized (ratio 0.822052401746725 )"
    ## [1] "read:cell ratio for lib55A TiteSeq_08_bin4 is 45.2083333333333"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin1 is 1.66010936775171"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin2 is 2.01461548587316"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin3 is 1"
    ## [1] "read:cell ratio for lib55A TiteSeq_09_bin4 is 1.16"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin1 , un-normalized (ratio 0.824034388173621 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_01_bin2 is 1.05330504355629"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin3 , un-normalized (ratio 0.912870019623811 )"
    ## [1] "reads < cells for lib56A TiteSeq_01_bin4 , un-normalized (ratio 0.952805605057222 )"
    ## [1] "reads < cells for lib56A TiteSeq_02_bin1 , un-normalized (ratio 0.865496813806267 )"
    ## [1] "reads < cells for lib56A TiteSeq_02_bin2 , un-normalized (ratio 0.929726120191688 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_02_bin3 is 1.06543051537742"
    ## [1] "read:cell ratio for lib56A TiteSeq_02_bin4 is 1.06618995295618"
    ## [1] "reads < cells for lib56A TiteSeq_03_bin1 , un-normalized (ratio 0.929989603724005 )"
    ## [1] "reads < cells for lib56A TiteSeq_03_bin2 , un-normalized (ratio 0.986928370685693 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_03_bin3 is 1.12118282649862"
    ## [1] "read:cell ratio for lib56A TiteSeq_03_bin4 is 2.07135085534509"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin1 is 1.01744071124138"
    ## [1] "reads < cells for lib56A TiteSeq_04_bin2 , un-normalized (ratio 0.939864125104759 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin3 is 1.42181359706576"
    ## [1] "read:cell ratio for lib56A TiteSeq_04_bin4 is 6.77053944850074"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin1 , un-normalized (ratio 0.983279419327589 )"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin2 , un-normalized (ratio 0.819365635038181 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_05_bin3 is 3.80730525531122"
    ## [1] "reads < cells for lib56A TiteSeq_05_bin4 , un-normalized (ratio 0.441916167664671 )"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin1 , un-normalized (ratio 0.869122988205857 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_06_bin2 is 1.39492624527899"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin3 , un-normalized (ratio 0.774863928748144 )"
    ## [1] "reads < cells for lib56A TiteSeq_06_bin4 , un-normalized (ratio 0.433862433862434 )"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin1 , un-normalized (ratio 0.759099141751176 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_07_bin2 is 1.27592407919044"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin3 , un-normalized (ratio 0.368821292775665 )"
    ## [1] "reads < cells for lib56A TiteSeq_07_bin4 , un-normalized (ratio 0.558441558441558 )"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin1 , un-normalized (ratio 0.908171506181806 )"
    ## [1] "read:cell ratio for lib56A TiteSeq_08_bin2 is 1.34746943628999"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin3 , un-normalized (ratio 0.357618651124063 )"
    ## [1] "reads < cells for lib56A TiteSeq_08_bin4 , un-normalized (ratio 0.403846153846154 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin1 , un-normalized (ratio 0.862135575307991 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin2 , un-normalized (ratio 0.643105694326657 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin3 , un-normalized (ratio 0.492592592592593 )"
    ## [1] "reads < cells for lib56A TiteSeq_09_bin4 , un-normalized (ratio 0.363636363636364 )"
...
We successfully generated *K*<sub>D</sub> estimates for 33786 of our
lib55A barcodes (75.8%), and 21976 of our lib56A barcodes (72.38%).
...
We have generated binding measurements for 73.23% of the barcodes in our
libraries.
